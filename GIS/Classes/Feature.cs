...
namespace GIS.Classes.DrawObjects
{
    internal class Feature
    {
        ...
        private GeoObject Geometry { get; set; }
        public GraphicObject? Figure { get; set; }
 
        public Feature(GeoObject geo, Dictionary<String, String> props)
        {
            Geometry = geo;
            this.props = props;
        }
        ...
        public void UpdateFigure(double offsetX, double offsetY, double scale = 1)
        {
            Figure.Update(offsetX, offsetY, scale);
        }
    }
}
